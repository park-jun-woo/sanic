...
# ff:what Main configuration object for Sanic application settings
...
from sanic.config.descriptor_meta import DescriptorMeta
from sanic.config.detailed_converter import DetailedConverter
...
class Config(dict, metaclass=DescriptorMeta):
    ...
    def load_environment_vars(self, prefix=SANIC_PREFIX):
        ...
        for key, value in environ.items():
            ...
            self._apply_converter(key, config_key, value)

    def _apply_converter(self, key, config_key, value):
