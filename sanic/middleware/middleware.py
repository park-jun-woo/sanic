# ff:type feature=middleware type=middleware
# ff:what Middleware wrapper object that encapsulates middleware functions with
...
from sanic.middleware.middleware_location import MiddlewareLocation
